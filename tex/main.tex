...
\begin{figure}[htb!]
  \caption{Seasonal distribution of relevant VI parameters and indoor air contaminant concentration at the ASU site. Only period after land drain was closed considered.}
...
% Add references motivating the choice of parameters
