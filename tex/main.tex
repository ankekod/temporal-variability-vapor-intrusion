...
We consider the source of the variability at VI sites located near Hill Air Force Base (AFB) in Utah, an EPA experimental house in Indiana, and Naval Air Station North Island in California and in particular how the indoor/outdoor pressure difference and air exchange rate affected indoor air contaminant concentrations at these sites.
We investigate how these dynamics differ for a site that is characterized by a preferential pathway (like Hill AFB) and a more "typical" VI site through three-dimensional fluid dynamics models and statistical analysis of the aforementioned sites.
For such a preferential pathway to impact a VI site, a medium for effective communication between the preferential pathway and the indoor air space must exist, e.g. a permeable region in the subslab (gravel layer).
Sites characterized by significant advective transport from the subslab to the indoor air space, much of short-term variability in indoor air contaminant concentration may be explained by fluctuations in indoor/outdoor pressure differences; air exchange rate drives most of the short-term variability for sites characterized by little advective transport.
\end{abstract}
