...
This period of CPM testing is thus excluded from the otherwise ”natural” VI conditions in the analysis.
...
Much of the analysis relies on an probability density estimation technique called "kernel density estimation",
...
The numpy, scipy, and pandas python packages were also used to conduct all statistical analysis and processing, with plotting done by the matplotlib, seaborn packages. % TODO: Add references to the
