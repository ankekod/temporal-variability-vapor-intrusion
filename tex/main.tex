...
\begin{table}
  ...
  \begin{tabular}{l c c c c c c}
    ...
    % Ground surface
    Groundsurface & \multicolumn{3}{c}{$p = 0 \; \mathrm{(Pa)}$} & \multicolumn{3}{c}{$c = 0 \; \mathrm{(\mu g/m^3)}$} \\
    % Preferential pathway
    Preferential & \multicolumn{3}{c}{$p = 0 \; \mathrm{(Pa)}$} & \multicolumn{3}{c}{$c = c_\mathrm{gw} K_H \chi \; \mathrm{(\mu g/m^3)}$} \\
    \midrule
    \multicolumn{7}{c}{\textbf{Soil \& gravel properties}\cite{dan_capillary_2012,abreu_conceptual_2012,u.s._environmental_protection_agency_userss_2004}} \\
    \midrule
...
\begin{table}[htb!]
 ...
 \begin{tabular}{l l l}
  \toprule
  \textbf{Boundary}            & \textbf{Richard's equation}              & \textbf{Transport equation}                                      \\
  % Foundation crack
