...
Sewers have been shown to play significant roles as preferential pathways and sampling nearby manholes for the presence for contaminants is a simple way to determine if a preferential pathway may play a role at the site.
Similar and other suggested screening methods have been described by Nielsen et al.\cite{nielsen_remediation_2017}, Pennell et al.\cite{pennell_sewer_2013}, and McHugh et al.\cite{mchugh_evidence_2017}.\par

Even in the absence of a preferential pathway, monitoring the indoor/outdoor pressure difference at a site may be we wise.
As was observed at North Island NAS, the significant fluctuations in pressurization lead to significant fluctuations in indoor air contaminant concentrations.
Knowing how the pressurization fluctuates may help inform how much temporal variability one may expect at a VI site; larger fluctuations combined with relatively permeable soils and/or leaky buildings lead to more significant temporal variability in indoor air contaminant concentrations, requiring indoor samples to be taken with a finer time-resolution than usual.
Under these circumstances, there may be need for continuous monitoring of indoor air contaminant concentration.\par
...
This adds to the concerns of overly relying on subslab contaminant samples in VI investigations due to the significant spatial variability of vapor contaminants at VI site like the ASU house and others\cite{chow_concentration_2007,folkes_observed_2009,u.s._environmental_protection_agency_assessment_2015}.
This is further complicated by the fact that the building itself can influence the subslab and create plumes of contaminant vapor\cite{holton_creation_2018}.
Collecting subslab samples can yield important information, but site investigators should be aware of the potential issues and ask themselves if it is worth the effort to collect these samples.\par
...
This suggests that 24-hour indoor air samples may be the most appropriate choice of sample collection time, avoiding diurnal concerns as well as capturing the variability of a few factors over a day.
Samples collected over longer time-periods, i.e. 48- or 72-hours, are unlikely to yield a different concentration than a 24-hour samples.
For the same reason, multiple samples should be spaced several days or few weeks apart to avoid duplicate samples.
Passive samples could be a cost effective way in conjunction with 24-hour samples to understand the long-term indoor air contaminant concentration trends.
The analysis in Figure \ref{fig:resampling} also implies that if a 24-hour sample gives a indoor air contaminant concentration that deceeds some regulatory limit by an order of magnitude or more, it is unlikely that the indoor air contaminant concentration will exceed this value at a later date; further sampling may not be necessary.\par
